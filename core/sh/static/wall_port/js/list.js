    ...
    columnDefs: [
      {
        ...
        render: function(data, type, row){
          let buttons = '<a href="/sh/wall_port/edit/'+row.id+'/" type="button" class="btn bg-custom-warning"><i class="fas fa-edit"></i></a> ';
          buttons += '<a href="/sh/wall_port/delete/'+row.id+'/" type="button" class="btn bg-custom-danger"><i class="fas fa-trash-alt"></i></a> ';
          return buttons
        }
      },
      {
