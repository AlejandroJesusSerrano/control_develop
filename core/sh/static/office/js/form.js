$(document).ready(function() {
  ...
  const fields = ['province', 'location', 'dependency', 'edifice', 'loc' ];
  ...
  initializeFormSubmisssion('#officeForm', 'add');
...
//     updateEdificeOptions(null, province_id);
//   } else {
...
//     updateEdificeOptions(null, province_id, location_id)
//   } else {
//     clearDependentFields(['#id_dependency', '#id_edifice', '#id_loc'])
//   }
// }

// function updateEdificeOptions(edifice_id, province_id, location_id) {

//   const params = {};

//   if (edifice_id) params.edifice_id = edifice_id;
//   if (province_id) params.province_id = province_id;
//   if (location_id) params.location_id = location_id;

//   if (Object.keys(params).length > 0) {

//     updateOptions('/sh/ajax/load_loc/', params,
//       $('select[name="loc"]'),
