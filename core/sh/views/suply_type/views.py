...
class SuplyTypeListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['add_btn_title'] = 'Agregar Tipo de Insumo'
        return context
...
class SuplyTypeCreateView(CreateView):
    ...
    def get_template_names(self):
        if self.request.GET.get('popup') == '1':
            return ['suply_type/popup_add.html']
        return ['suply_type/create.html']
        ...
        try:
            ...
            if self.request.headers.get('x-requested-with') == 'XMLHttpRequest':
                data = {
                    ...
                    'suply_type_id': self.object.id,
                    'suply_type_name': self.object.suply_type
                }
