...
class PatcheraListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['add_btn_title'] = 'Agregar Patchera'
        return context
...
class PatcheraCreateView(CreateView):
    ...
    def get_template_names(self):
        if self.request.GET.get('popup') == '1':
            return ['patchera/popup_add.html']
        return ['patchera/create.html']
        ...
        try:
            ...
            if self.request.headers.get('x-requested-with') == 'XMLHttpRequest':
                data = {
                    ...
                    'patchera_id': self.object.id,
                    'patchera_name': self.object.patchera,
                    'pathcera_rack': self.object.rack.rack,
                }
