...
class Connection_TypeListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['add_btn_title'] = 'Agregar Tipo de Conexión'
        return context
...
class Connection_TypeCreateView(CreateView):
    ...
    def get_template_names(self):
        if self.request.GET.get('popup') == '1':
            return ['connection_type/popup_add.html']
        return ['connection_type/create.html']
        ...
        try:
            ...
            if self.request.headers.get('x-requested-with') == 'XMLHttpRequest':
                data = {
                    ...
                    'connection_type_id': self.object.id,
                    'connection_type_name': self.object.connection_type
                }
