...
from core.sh.views.device.views import DeviceCreateView, DeviceDeleteView, DeviceListView, DeviceUpadateView
...
urlpatterns = [
  ...
  path('device/edit/<int:pk>/', DeviceUpadateView.as_view(), name='device_edit'),
