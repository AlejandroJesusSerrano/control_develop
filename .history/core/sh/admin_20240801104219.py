...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_type', 'get_brand', 'dev_model', 'connection', 'ip', 'net_name','serial_n', 'dev_status', 'get_employee')
  list_instances = True
  search_fields = ['dev_model__dev_model','dev_model__brand__brand', 'serial_n']
