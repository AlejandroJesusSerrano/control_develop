...
class Device(models.Model):
  ...
  employee = models.ForeignKey(Employee, related_name='device_employee', verbose_name='Empleado', on_delete=models.CASCADE)
  ...
  def toJSON(self):
    ...
    item['office'] = self.office.office
    item['employees'] = [employee.toJSON() for employee in self.employee.all()]
    return item
