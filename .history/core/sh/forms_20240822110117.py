...
class DeviceForm(forms.ModelForm):
  ...
  class Meta:
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Inicializa los queryset en None para wall_port, switch_port y employee
        self.fields['wall_port'].queryset = Wall_Port.objects.none()
        self.fields['switch_port'].queryset = Switch_Port.objects.none()
        self.fields['employee'].queryset = Employee.objects.none()

        if self.instance.pk:
            # Si es una instancia existente, cargar los queryset correspondientes
        ...
        # Si se está creando o actualizando y se pasó información en el POST
        elif 'office' in self.data:
            try:
                ...
                pass  # Entrada no válida; ignorar y fallback a queryset vacío
    ...
    def clean(self):
        ...
        print("Cleaned data: ", cleaned_data)  # Ver el estado de los datos limpiados
        return cleaned_data
  ...
  #   if self.instance.pk:
  #     self.fields['wall_port'].queryset = Wall_Port.objects.filter(office=self.instance.office)
  #     self.fields['switch_por'].queryset = Switch_Port.objects.filter(switch__office=self.instance.office)
  #     self.fields['employee'].queryset = Employee.objects.filter(office=self.instance.office)
  #     self.fields['dev_model'].queryset = Dev_Model.objects.filter(
  #       brand = self.instance.dev_model.brand,
  #       dev_type=self.instance.dev_model.dev_type
  ...
  #       pass
    ...
    #   self.fields['dev_model'].queryset = Dev_Model.objects.filter(
    #     brand_id=self.instance.dev_model.brand_id,
    #     dev_type_id= self.instance.dev_model.dev_type_id
    #   )
    #   self.fields['wall_port'].queryset = Wall_Port.objects.filter(
    #     office=self.instance.office
    #   )
    #   self.fields['switch_port'].queryset = Switch_Port.objects.filter(
    #     switch__office=self.instance.office
    #   )
