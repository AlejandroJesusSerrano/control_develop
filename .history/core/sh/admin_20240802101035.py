...
class PatchPortAdmin(admin.ModelAdmin):
  ...
  list_filter = ['patch__rack__rack', 'patch__patch']
  ordering = ['patch__rack__rack', 'patch__patch','port']
...
class SwitchAdmin(admin.ModelAdmin):
  ...
  list_display = ('brand','serial_n', 'ports_q', 'rack', 'switch_rack_pos, office')
  list_instances = True
  search_fields = ['brand__brand', 'serial_n', 'ports_q', 'rack__rack', 'switch_rack_pos', 'office_office']
  list_filter = ['brand__brand', 'ports_q', 'rack__rack', 'office__office']
  ordering = ['brand__brand', 'serial_n', 'ports_q', 'rack__rack', 'switch_rack_pos', 'office_office']
