...
class Device(models.Model):
  ...
  employee = models.ManyToManyField(Employee, related_name='device_employee', verbose_name='Empleado', on_delete=models.CASCADE)
  ...
  def toJSON(self):
    ...
    item['office'] = self.office.office
    item['employee'] = self.employee.employee_last_name
    return item
