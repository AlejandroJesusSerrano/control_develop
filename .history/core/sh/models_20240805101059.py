...
class Move_Type(models.Model):
  move = models.CharField(max_length = 75, verbose_name = 'Movimiento')
  date_creation = models.DateTimeField(auto_now = True, verbose_name = 'Fecha de Registro')
  date_updated = models.DateTimeField(auto_now_add = True, verbose_name = 'Última Modificación')
...
class Movements(models.Model):
  ...
  move = models.ManyToManyField(Move_Type, related_name = 'movement_move_type', verbose_name = 'Movimiento', on_delete = models.CASCADE)
