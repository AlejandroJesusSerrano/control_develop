...
class SwitchPortAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_switchRack', 'get_switchRackPos', 'get_switch_brand', 'get_switch_ports', 'get_switch_rack_pos', 'port_id','patch_port_out', 'patch_port_in', 'switch_in', 'switch_out', 'obs')
  list_instances = True
