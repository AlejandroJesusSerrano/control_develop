...
function updateOptions(url, data, selectElement) {
  ...
  $('#id_dev_model').val($('#id_dev_model').data('preselected')).trigger('change');
  $('#id_wall_port').val($('#id_wall_port').data('preselected')).trigger('change');
  $('#id_switch_port').val($('#id_switch_port').data('preselected')).trigger('change');
  $('#id_employee').val($('#id_employee').data('preselected')).trigger('change');
