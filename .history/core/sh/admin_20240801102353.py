...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_type', 'get_brand', 'dev_model', 'connection', 'ip', 'serial_n', 'net_name', 'dev_status', 'get_employee')
  list_instances = True
  search_fields = ['get_brand', 'dev_model']
  ...
  def get_employee(self, obj):
    return ", ".join([f"{empl.employee_last_name}, {empl.employee_name}, Oficina: {empl.office.office}" for empl in obj.employee.all()])
