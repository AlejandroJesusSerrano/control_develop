...
class EdificeAdmin(admin.ModelAdmin):
  ...
  list_display = ('edifice', 'address', 'location', 'get_province', 'date_creation', 'date_updated')
  list_instances = True
  search_fields = ['edifice', 'address', 'location', 'location__province__province', 'date_creation', 'date_updated']
  list_filter = ['edifice', 'address', 'location', 'location__province__province', 'date_creation', 'date_updated']
  ordering = ['edifice', 'address', 'location', 'location__province__province', 'date_creation', 'date_updated']
