...
class OfficeForm(forms.ModelForm):
  ...
  edifice=Edifice.ModelChoiceField(
  ...
  class Meta:
    model = Office
    fields = [
      'dependency', 'loc__floor', 'loc__wing', 'office', 'description'
      ]
    widget = {
      'dependency': Select(attrs={'class': 'form-control select2'}),
      'loc__floor': Select(attrs={'class': 'form-control select2'}),
      'loc__wing': Select(attrs={'class': 'form-control selectt2'}),
