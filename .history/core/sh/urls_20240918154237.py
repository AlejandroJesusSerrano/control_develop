...
from core.sh.views.edifice.views import EdificeListView, EdificeCreateView, EdificeUpdateView, EdificeDeleteView, ajax_search_location
...
urlpatterns = [
  ...
  # Edifice Ajax Route
  path('ajax/search_location/', ajax_search_location, name='ajax_edifice_search_location'),
  # Dependency
