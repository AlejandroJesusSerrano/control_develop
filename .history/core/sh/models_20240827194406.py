...
class Device(models.Model):
  ...
  wall_port = models.ForeignKey(Wall_Port, related_name='device_wall_port', verbose_name='Boca de la pared', on_delete=models.CASCADE, blank=True, null=True, unique=True)
  switch_port = models.ForeignKey(Switch_Port, related_name='device_switch_port', verbose_name='Puerto de Switch', on_delete=models.CASCADE, blank=True, null=True, unique=True)
