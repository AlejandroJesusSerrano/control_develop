...
class MovementAdmnin(admin.ModelAdmin):
  list_display = ('get_type', 'date', 'get_model', 'get_user', 'get_office', 'techs', 'suply', 'detail')
  list_instances = True
  ...
  def get_user(self,obj):
    user_name = obj.device.employee.employee_name
    user_last_name =  obj.device.employee.employee_last_name
    return user_name+', '+user_last_name
  get_user.short_description = 'Usuario'
  get_model.admin_order_field = 'device__employee__employee_last_name'
