...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_instances = True
  search_fields = ['dev_model__dev_type__dev_type','dev_model__dev_model','dev_model__brand__brand','ip', 'serial_n', 'net_name', 'office']
  list_filter = ['dev_model__dev_type__dev_type','dev_model__dev_model','dev_model__brand__brand','ip', 'serial_n', 'net_name', 'office']
