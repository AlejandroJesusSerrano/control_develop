...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_brand', 'dev_model', 'dev_status', 'get_employee')
  list_instances = True
  ...
  def get_employee(self, obj):
    return ", ".join([f"{empl.employee_last_name}, {empl.employee_name}, Oficina: {empl.office.office}" for empl in obj.employees.all()])
