...
class DeviceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            # Pre-fill the fields with the instance data for edit view
            ...
            # If this is a create view, start with empty querysets
        ...
        # Handle dynamic querysets on POST
...
# ! esto es un comentario previo
    ...
    #     office = self.instance.office
    #   )
# ! esto que sigue es del formulario actual
  # def clean(self):
