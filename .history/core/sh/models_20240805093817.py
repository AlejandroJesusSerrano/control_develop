...
class Wall_Port(models.Model):
    ...
    def __str__(self):
        ...
        return f'BOCA: {self.wall_port} EN OFICINA {self.office.office} -> ENTRADA DE SEÑAL: {patch_port_in_info} -> {switch_port_in_info} -> SALIDA DE LA SEÑAL: {switch_info} -> {patch_port_out_info} -> {switch_port_out_info}'
