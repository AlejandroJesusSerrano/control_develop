...
class SwitchAdmin(admin.ModelAdmin):
  ...
  list_instances = True
  search_fields = ['model__dev_type__dev_type', 'model__brand__brand', 'model__model', 'serial_n', 'ports_q', 'rack__rack', 'switch_rack_pos', 'office__office']
  list_filter = ['model__dev_type__dev_type', 'model__brand__brand', 'model__model', 'ports_q', 'rack__rack', 'office__office']
  ordering = ['model__dev_type__dev_type', 'model__brand__brand', 'model__model', 'serial_n', 'ports_q', 'rack__rack', 'switch_rack_pos', 'office__office']
