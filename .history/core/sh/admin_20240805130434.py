...
class OfficeLocAdmin(admin.ModelAdmin):
  ...
  list_instances = True
  search_fields = ['edifice__edifice', 'get_location', 'floor', 'wing', 'date_creation', 'date_updated']
  list_filter = ['edifice__edifice', 'get_location', 'floor', 'wing', 'date_creation', 'date_updated']
  ordering = ['edifice__edifice', 'get_location', 'floor', 'wing', 'date_creation', 'date_updated']
