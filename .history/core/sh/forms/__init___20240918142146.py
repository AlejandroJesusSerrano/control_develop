...
from core.sh.forms.switch_port.forms import SwitchPortForm
from core.sh.forms.tehcs.forms import TechsForm
from core.sh.forms.wall_port.forms import WallPortForm