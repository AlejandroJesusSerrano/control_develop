...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_filter = ['dev_model__dev_type__dev_type', 'dev_model__dev_model', 'dev_model__brand__brand', 'ip', 'serial_n', 'net_name', 'office__office', 'wall_port', 'switch_port']
  ordering = ['dev_model__dev_type__dev_type', 'dev_model__brand__brand', 'dev_model__dev_model', 'dev_model__brand__brand', 'ip', 'serial_n', 'net_name', 'office__office', 'wall_port', 'switch_port']
