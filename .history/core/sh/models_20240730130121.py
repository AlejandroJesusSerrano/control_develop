...
class Device(models.Model):
  ...
  net_name = models.CharField(max_length = 11, verbose_name='ID en la Red')
  ...
  def toJson(self):
    item = model_to_dict(self)
    item['type'] = self.dev_model.dev_type
    item['brand'] = self.dev_model.brand
    ...
    item['employees'] = [
      {
        'e_name': employee.employee_name,
        'e_last_name': employee.employee_last_name,
        'e_cuil': employee.cuil,
        'e_office': employee.office.office,
      }
