...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_type', 'get_brand', 'dev_model', 'connection', 'ip', 'serial_n', 'dev_status', 'get_employee', 'office', 'get_wallport')
  list_instances = True
  search_fields = ['dev_model__dev_type__dev_type','dev_model__dev_model','dev_model__brand__brand','ip', 'serial_n', 'net_name']
  list_filter = ['dev_model__dev_model','dev_model__brand__brand', 'serial_n', 'net_name']
  ...
  def get_wallport(self, obj):
    return obj.wall_port.wall_port
