...
class SwitchPortAdmin(admin.ModelAdmin):
  ...
  list_display = ('get_switch_brand', 'get_switch_ports', 'switch', 'port_id','patch_port_out', 'patch_port_in', 'switch_in', 'switch_out', 'obs')
  list_instances = True
  search_fields = ['switch', 'port_id','patch_port_out', 'patch_port_in', 'switch_in', 'switch_out', 'obs']
  list_filter = ['switch', 'port_id','patch_port_out', 'patch_port_in', 'switch_in', 'switch_out', 'obs']
  ordering = ['switch', 'port_id','patch_port_out', 'patch_port_in', 'switch_in', 'switch_out', 'obs']
