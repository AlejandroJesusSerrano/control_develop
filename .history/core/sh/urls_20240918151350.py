...
from core.sh.views.edifice import views as edifice_views
from core.sh.views.edifice.views import EdificeListView, EdificeCreateView, EdificeUpdateView, EdificeDeleteView
...
urlpatterns = [
  ...
  # Edifice
  path('edifice/list/', edifice_views.EdificeListView.as_view(), name='edifice_list'),
  path('edifice/add/', edifice_views.EdificeCreateView.as_view(), name='edifice_add'),
  path('edifice/edit/<int:pk>/', edifice_views.EdificeUpadateView.as_view(), name='edifice_edit'),
  path('edifice/delete/<int:pk>/', edifice_views.EdificeDeleteView.as_view(), name='edifice_delete'),
  # Edifice Ajax Route
  path('ajax/search_location/', edifice_views.ajax_search_location, name='ajax_search_edifice_location'),
  # Dependency
