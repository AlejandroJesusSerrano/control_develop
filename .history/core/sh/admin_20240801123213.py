...
class DeviceAdmin(admin.ModelAdmin):
  ...
  list_instances = True
  search_fields = ['dev_model__dev_type__dev_type', 'dev_model__brand__brand','dev_model__dev_model','ip', 'serial_n', 'net_name', 'employee__employee_last_name', 'employee__employee_name', 'office', 'get_wallPort__wall_port', 'get_switchPort__port_id']
  list_filter = ['dev_model__dev_type__dev_type', 'dev_model__brand__brand', 'dev_model__dev_model',  'ip', 'serial_n', 'net_name', 'employee__employee_last_name', 'office__office', 'wall_port', 'switch_port']
  ordering = ['dev_model__dev_type__dev_type', 'dev_model__brand__brand', 'dev_model__dev_model',  'ip', 'serial_n', 'net_name', 'employee__employee_last_name', 'office__office', 'wall_port', 'switch_port']
