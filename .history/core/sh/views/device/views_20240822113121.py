...
class DeviceUpadateView(UpdateView):
    ...
    def get_initial(self):
      ...
      initial['brand'] = device.dev_model.brand.id if device.dev_model.brand else None
      initial['dev_type'] = device.dev_model.dev_type.id if device.dev_model.dev_type else None
      initial['dev_model'] = device.dev_model.id if device.dev_models else None
