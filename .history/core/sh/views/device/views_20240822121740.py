...
class DeviceUpdateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Set the initial data to pre-fill the form with the existing data
