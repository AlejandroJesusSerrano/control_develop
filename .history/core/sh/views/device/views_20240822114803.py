...
class DeviceUpadateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['form'].initial['dev_model'].widget.attrs['value'] = device.dev_model.id if device.dev_model else None
        context['form'].initial['wall_port'].widget.attrs['value'] = device.wall_port.id if device.wall_port else None
        context['form'].initial['switch_port'].widget.attrs['value'] = device.switch_port.id if device.switch_port else None
        context['form'].initial['employee'].widget.attrs['value'] = [emp.id for emp in device.employee.all()] if device.employee.exists() else None
