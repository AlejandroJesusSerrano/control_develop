...
class OfficeUpadateView(UpdateView):
  ...
  def get_context_data(self, **kwargs):
      ...
      context['form'].fields['edifice'].queryset = Edifice.objects.filter(
        location = office.edifice.location,
      )
      ...
      context['form'].initial['location'] = office.dependency.location.id if office.edifice.location else None
      context['form'].initial['dependency'] = office.dependency.id if office.dependency else None
      context['form'].initial['edifice'] = office.edifice.id if office.edifice.location else None
