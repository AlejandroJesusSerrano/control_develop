          ...
          $.ajax({
            ...
            if(data.hasOwnProperty('success') && data.success === true){
              callback();
                ...
                error_msg(data.error || 'Ocurrio un error desconocido');
              }
...
$('form[data-form-id]').on('submit', function(e){
  e.preventDefault();

  let form = $(this);
  let params = new FormData(this);
  let actionType = form.data('action');

  submit_with_ajax(form.attr('action'), params, function(){
